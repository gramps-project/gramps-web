export default {
  ...
  "To start using the blog, add a source with tag 'Blog'.":
    'Um den Blog zu starten, füge eine Quelle mit der Markierung „Blog“ hinzu.',
  'Welcome to Gramps Web': 'Willkommen bei Gramps Web',
  'Create an admin account': 'Ein Administratorkonto erstellen',
  'Enter the details for the admin user.':
    'Die Details für den Admin-Benutzer eingeben.',
  'Optionally, enter existing IMAP credentials to enable e-mail notifications required e.g. for user registration.':
    'Optional müssen vorhandene IMAP-Zugangsdaten eingegeben werden, um Email-Benachrichtigungen zu aktivieren, die z. B. für die Benutzerregistrierung erforderlich sind.',
  'SMTP host': 'SMTP-Host',
  'SMTP port': 'SMTP-Port',
  ...
  'Optionally, upload existing family tree data.':
    'Optional besteht die Möglichkeit, vorhandene Stammbaumdaten hochzuladen.',
  ...
  'The Gramps package format (.gpkg) is currently not supported.':
    'Das Gramps-Paketformat (.gpkg) wird derzeit nicht unterstützt.',
  'Please upload a file in Gramps XML (.gramps) format without media files.':
    'Bitte eine Datei im Gramps XML (.gramps) Format ohne Mediendateien hochladen.',
  'If you intend to synchronize an existing Gramps database with Gramps Web, use the Gramps XML (.gramps) format instead.':
    'Wenn Sie eine bestehende Gramps-Datenbank mit Gramps Web synchronisieren möchten, verwenden Sie stattdessen das Gramps-XML-Format (.gramps).',
  ...
  'Importing family tree': 'Stammbaum importieren',
  Month: 'Monat',
  ...
  'Please confirm your e-mail address by clicking the link in the e-mail you received and then wait for the tree owner to activate your account.':
    'Bitte bestätige deine Email-Adresse, indem du auf den Link im Email klickst, das du erhalten hast, und warte dann darauf, dass der Baumbesitzer dein Konto aktiviert.',
  Tasks: 'Aufgaben',
  ...
  'Creating owner account': 'Eigentümerkonto erstellen',
  'Storing configuration': 'Konfiguration speichern',
  ...
  'Manually updating the search index is usually unnecessary, but it may become necessary after an upgrade.':
    'Eine manuelle Aktualisierung des Suchindexes ist in der Regel nicht erforderlich, kann aber nach einem Upgrade notwendig werden.',
  ...
  'New account registered successfully.':
    'Neues Konto erfolgreich registriert.',
  'A password reset link has been sent by e-mail.':
    'Ein Link zum Zurücksetzen des Passworts wurde per Email versendet.',
  ...
  'Upload a ZIP archive with files for existing media objects.':
    'Lade ein ZIP-Archiv mit Dateien für vorhandene Medienobjekte hoch.',
  ...
  'Generate a ZIP archive with all media files.':
    'Erzeuge ein ZIP-Archiv mit allen Mediendateien.',
  Task: 'Aufgabe',
  ...
  'This tool checks the database for integrity problems, fixing the problems it can.':
    'Dieses Werkzeug überprüft die Datenbank auf Integritätsprobleme und behebt die Probleme, die es lösen kann.',
  '%s media objects with missing file': '%s Medienobjekte mit abgehender Datei',
  '%s media objects with missing checksum':
    '%s Medienobjekte mit abgehender Prüfsumme',
  'Only places related to events': 'Nur Orte in Zusammenhang mit Ereignissen',
  ...
  'The Family Tree you are trying to load is in a schema version not supported by this version of Gramps Web. Therefore you cannot load this Family Tree without upgrading its schema. This action cannot be undone.':
    'Das Datenbankschema des Stammbaums, den du zu laden versuchst, ist in einer Version, die von dieser Version von Gramps Web nicht unterstützt wird. Daher kannst du diesen Stammbaum nicht laden ohne sein Schema zu aktualisieren. Diese Aktion kann nicht rückgängig gemacht werden.',
  ...
  'Clear the family tree by removing all existing objects. Optionally, select specific types of objects for deletion.':
    'Leere den Stammbaum durch Löschen aller vorhandenen Objekte. Optional können bestimmte Objektarten zur Löschung ausgewählt werden.',
  'Wrong username or password': 'Benutzername oder Passwort falsch',
  'Password successfully updated': 'Passwort erfolgreich geändert',
  'E-mail successfully updated': 'Emailadresse erfolgreich geändert',
  'Danger Zone': 'Gefahrenbereich',
  'Delete all objects': 'Alle Objekte löschen',
  'Please re-enter your password to continue.':
    'Bitte gib das Passwort zum Fortfahren erneut ein.',
  ...
  'Delete Tag': 'Markierung löschen',
  'Edit Tag': 'Markierung bearbeiten',
}
