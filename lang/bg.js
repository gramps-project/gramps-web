export default {
  ...
  "To start using the blog, add a source with tag 'Blog'.":
    'За да започнете да използвате блога, добавете източник с етикет „Блог“.',
  All: 'Всички',
  Username: 'Потребителско име',
  'Manage users': 'Смяна на потребителите',
  'Generate a ZIP archive with all media files.':
    'Генерирайте ZIP архив с всички медийни файлове.',
  ...
  'Please confirm your e-mail address by clicking the link in the e-mail you received and then wait for the tree owner to activate your account.':
    'Моля, потвърдете своя имейл адрес, като щракнете върху връзката в имейла, който сте получили, и след това изчакайте собственикът на дървото да активира вашия акаунт.',
  ...
  'Enter the details for the admin user.':
    'Въведете данните за администраторския потребител.',
  Day: 'Ден',
  ...
  'Optionally, upload existing family tree data.':
    'По желание качете съществуващи данни за родословно дърво.',
  ...
  'Optionally, enter existing IMAP credentials to enable e-mail notifications required e.g. for user registration.':
    'По избор въведете съществуващи идентификационни данни за IMAP, за да активирате известията по имейл, необходими напр. за регистрация на потребител.',
  'Latest Blog Post': 'Последна публикация в блога',
  unconfirmed: 'непотвърдено',
  login: 'логин',
  Member: 'Член',
  'This e-mail address is already in use':
    'Този е-мейл адрес е вече в употреба',
  ...
  'Manually updating the search index is usually unnecessary, but it may become necessary after an upgrade.':
    'Ръчното актуализиране на индекса за търсене обикновено не е необходимо, но може да стане необходимо след надграждане.',
