export default {
  'Create an admin account': 'Stwórz konto administratora',
  'Recently changed objects': 'Ostatnio zmieniane obiekty',
  'Select language': 'Wybierz język',
  'Show in tree': 'Pokaż na drzewie',
  Search: 'Szukaj',
  Navigation: 'Nawigacja',
  Global: 'Globalne',
  'Align the image': 'Wyrównaj obraz',
  'Latest Blog Post': 'Najnowszy wpis na blogu',
  'Edit coordinates': 'Edytuj współrzędne',
  'Select an existing citation': 'Wybierz istniejące odwołanie',
  'Keyboard Shortcuts': 'Skróty klawiszowe',
  'Welcome to Gramps Web': 'Witaj w Gramps Web',
  "To start using the blog, add a source with tag 'Blog'.":
    "Aby zacząć używać bloga, dodaj źródło z etykietą 'Blog'.",
  'Show this dialog': 'Pokaż okno dialogowe',
  'Enter the details for the admin user.': 'Wprowadź dane administratora.',
  ...
  'Recently browsed objects': 'Ostatnio przeglądane obiekty',
  'User settings': 'Ustawienia użytkownika',
  Anniversaries: 'Rocznice',
  Export: 'Eksportuj',
  'Select a point on the map': 'Wybierz punkt na mapie',
  'SMTP host': 'Host SMTP',
  'SMTP port': 'Port SMTP',
  ...
  'If you intend to synchronize an existing Gramps database with Gramps Web, use the Gramps XML (.gramps) format instead.':
    'Jeżeli zamierzasz synchronizować istniejącą bazę danych Gramps z Gramps Web, w zamian użyj formatu Gramps XML (.gramps).',
  'Optionally, enter existing IMAP credentials to enable e-mail notifications required e.g. for user registration.':
    'Opcjonalnie, wstaw istniejące poświadczenia IMAP by włączyć powiadomienia e-mail wymagane np. do rejestracji użytkowników.',
  'SMTP password': 'Hasło SMTP',
  'From address': 'Z adresu',
  'Gramps Web base URL': 'Podstawowy adres URL Gramps Web',
  'Upload family tree': 'Prześlij drzewo genealogiczne',
  'Optionally, upload existing family tree data.':
    'Opcjonalnie, prześlij istniejące dane drzewa genealogicznego.',
  'Need help? Check out ': 'Potrzebujesz pomocy? Sprawdź ',
  ...
  'The Gramps package format (.gpkg) is currently not supported.':
    'Fomat paczek Gramps (.gpkg) nie jest obecnie wspierany.',
  'Please upload a file in Gramps XML (.gramps) format without media files.':
    'Proszę przesłać plik w formacie Gramps XML (.gramps) bez plików multimedialnych.',
  ...
  'Manually updating the search index is usually unnecessary, but it may become necessary after an upgrade.':
    'Ręczne aktualizowanie indeksu wyszukiwania jest zwykle zbędne, ale może być konieczne po uaktualnieniu.',
  ...
  'Generate a ZIP archive with all media files.':
    'Wygeneruj archiwum ZIP ze wszystkimi plikami multimedialnymi.',
  ...
  'New account registered successfully.':
    'Nowe konto zostało pomyślnie zarejestrowane.',
  'Please confirm your e-mail address by clicking the link in the e-mail you received and then wait for the tree owner to activate your account.':
    'Potwierdź swój adres e-mail, klikając link w otrzymanej wiadomości e-mail, a następnie poczekaj, aż właściciel drzewa aktywuje Twoje konto.',
  'A password reset link has been sent by e-mail.':
    'Link do resetowania hasła został wysłany pocztą e-mail.',
  'Usage quotas': 'Przydziały użycia',
  'Not authorized': 'Nieautoryzowany',
  'This e-mail address is already in use': 'Ten adres e-mail jest już w użyciu',
  'This user name is already in use': 'Nazwa użytkownika jest zajęta',
  'Copy URL': 'Kopiuj URL',
  'Upload a ZIP archive with files for existing media objects.':
    'Prześlij archiwum ZIP z plikami dla istniejących obiektów multimedialnych.',
  ...
  'Event Year': 'Rok wydarzenia',
  Task: 'Zadanie',
  Tasks: 'Zadania',
  'New Task': 'Nowe zadanie',
  'Show in blog': 'Pokaż na blogu',
  ...
  'Common ancestors': 'Wspólni przodkowie',
  Blocked: 'Zablokowano',
  'Edit place type': 'Edytowanie typu miejsca',
  'Edit event type': 'Edytowanie typu zdarzenia',
  'Ancestor frequency': 'Częstotliwość występowania przodków',
  'Bookmark this': 'Dodaj do zakładek',
  ...
  'Largest Segment': 'Największy segment',
  '%s media objects with missing file':
    '%s obiektów multimedialnych z brakującym plikiem',
  '%s media objects with missing checksum':
    '%s obiektów multimedialnych z brakującą sumą kontrolną',
  'Only places related to events': 'Tylko miejsca powiązane z wydarzeniami',
  'Media file status': 'Status pliku multimedialnego',
  'This tool checks the database for integrity problems, fixing the problems it can.':
    'Narzędzie to sprawdza bazę danych pod kątem problemów z integralnością, naprawiając je.',
  ...
  'Clear the family tree by removing all existing objects. Optionally, select specific types of objects for deletion.':
    'Wyczyść drzewo genealogiczne, usuwając wszystkie istniejące obiekty. Opcjonalnie można wybrać określone typy obiektów do usunięcia.',
  'E-mail successfully updated': 'E-mail został pomyślnie zaktualizowany',
  'Danger Zone': 'Niebezpieczna strefa',
  'Password is required': 'Hasło jest wymagane',
  'Delete all objects': 'Usuń wszystkie obiekty',
  'Please re-enter your password to continue.':
    'Wprowadź ponownie hasło, aby kontynuować.',
