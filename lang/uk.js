export default {
  ...
  Menu: 'Меню',
  'SMTP host': 'SMTP-хост',
  'Need help? Check out ': 'Потрібна допомога? Перевірте ',
  Blog: 'Блог',
  Lists: 'Списки',
  'Optionally, enter existing IMAP credentials to enable e-mail notifications required e.g. for user registration.':
    'За бажанням, введіть наявні облікові дані IMAP, щоб увімкнути сповіщення електронною поштою, необхідні, наприклад, для реєстрації користувача.',
  'Change password': 'Змінити пароль',
  'Manage users': 'Керування користувачами',
  'Change E-mail': 'Змінити електронну пошту',
  'New password': 'Новий пароль',
  'Recently changed objects': "Нещодавно змінені об'єкти",
  'Show in tree': 'Показати в дереві',
  Search: 'Пошук',
  Global: 'Глобальний',
  'Old password': 'Старий пароль',
  'Recently browsed objects': "Нещодавно переглянуті об'єкти",
  'Align the image': 'Вирівняти зображення',
  'Place Hierarchy': 'Ієрархія місць',
  History: 'Історія',
  'Latest Blog Post': 'Останні дописи в блозі',
  Export: 'Експорт',
  'Select a point on the map': 'Виберіть точку на мапі',
  'New E-mail': 'Нова електронна пошта',
  'Edit coordinates': 'Редагувати координати',
  'Select language': 'Оберіть мову',
  'User settings': 'Налаштування користувача',
  Anniversaries: 'Ювілеї',
  Navigation: 'Навігація',
  'Search %s': 'Пошук %s',
  'Select an existing citation': 'Виберіть наявну цитату',
  'Keyboard Shortcuts': 'Сполучення клавіш',
  'Show this dialog': 'Показати це діалогове вікно',
  'Welcome to Gramps Web': 'Ласкаво просимо до Gramps Web',
  'Create an admin account': 'Створіть обліковий запис адміністратора',
  'Enter the details for the admin user.':
    'Уведіть дані користувача-адміністратора.',
  'Please upload a file in Gramps XML (.gramps) format without media files.':
    'Завантажте файл у форматі Gramps XML (.gramps) без медіафайлів.',
  'Optionally, upload existing family tree data.':
    'За бажанням, завантажте наявні дані сімейного дерева.',
  All: 'Усе',
  'If you intend to synchronize an existing Gramps database with Gramps Web, use the Gramps XML (.gramps) format instead.':
    'Якщо ви маєте намір синхронізувати наявну базу даних Gramps з Gramps Web, використовуйте формат Gramps XML (.gramps).',
  'Select at least one object type': "Виберіть хоча б один тип об'єкта",
  "To start using the blog, add a source with tag 'Blog'.":
    'Щоб почати користуватися блогом, додайте джерело з міткою "Блог".',
  filter: 'фільтр',
  ...
  'Gramps Web base URL': 'Основна URL-адреса Gramps Web',
  'Upload family tree': 'Завантажити сімейне дерево',
  'the documentation': 'документацію',
  Submit: 'Надіслати',
  'Unsupported format': 'Непідтримуваний формат',
  'The Gramps package format (.gpkg) is currently not supported.':
    'Формат пакета Gramps (.gpkg) наразі не підтримується.',
  Username: "Ім'я користувача",
  Password: 'Пароль',
  login: 'логін',
  'Lost password?': 'Забули пароль?',
  'Register new account': 'Зареєструвати обліковий запис',
  Member: 'Учасник',
  ...
  'Manually updating the search index is usually unnecessary, but it may become necessary after an upgrade.':
    'Ручне оновлення пошукового індексу зазвичай не потрібне, але може стати необхідним після оновлення.',
  'Add a new user': 'Додавання нового користувача',
  'Export user details': 'Експорт даних користувача',
  'Import user accounts': 'Імпорт облікових записів користувачів',
  Administration: 'Адміністрування',
  'Manage search index': 'Керування пошуковим індексом',
  'Edit user': 'Редагування користувача',
  'Generate a ZIP archive with all media files.':
    'Створення архіву ZIP з усіма медіа файлами.',
  ...
  'A password reset link has been sent by e-mail.':
    'На вашу електронну пошту надіслано посилання для скидання пароля.',
  ...
  'Please confirm your e-mail address by clicking the link in the e-mail you received and then wait for the tree owner to activate your account.':
    'Підтвердьте вашу адресу електронної пошти, клацнувши на посиланні в електронному листі, що надійшов на вказану вами скриньку, і зачекайте, доки власник активує ваш обліковий запис.',
  ...
  'Upload a ZIP archive with files for existing media objects.':
    "Завантажити ZIP-архів з файлами для наявних медіаоб'єктів.",
  ...
  'New account registered successfully.':
    'Новий обліковий запис успішно зареєстровано.',
  ...
  'This e-mail address is already in use':
    'Ця адреса електронної пошти вже зайнята',
  ...
  'This tool checks the database for integrity problems, fixing the problems it can.':
    'Цей інструмент перевіряє бази даних на проблеми цілісності й усуває ті з них, які можливо.',
