...
class GrampsjsFormEditCitationDetails extends GrampsjsObjectForm {
  ...
  renderForm () {
    ...
    <p>
      <grampsjs-form-string fullwidth id="page" value="${this.data.page}"></grampsjs-form-string>
    </p>
...
window.customElements.define('grampsjs-form-edit-citation-details', GrampsjsFormEditCitationDetails)
