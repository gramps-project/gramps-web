...
export const GrampsjsNewPlaceMixin = superClass =>
  class extends superClass {
    ...
    // The lat/long events are stopped so that a form embedding this one in a
    // dialog does not mistake them for its own save or cancel.
