export default {
  ...
  'Please upload a file in Gramps XML (.gramps) format without media files.':
    'Penja un fitxer en format Gramps XML (.gramps) sense fitxers multimèdia.',
  ...
  "To start using the blog, add a source with tag 'Blog'.":
    "Per a començar a utilitzar el bloc, afegeix una font amb l'etiqueta «Bloc».",
  ...
  'Enter the details for the admin user.':
    "Introdueix les dades de l'usuari administrador.",
  'Optionally, enter existing IMAP credentials to enable e-mail notifications required e.g. for user registration.':
    "Opcionalment, introdueix les credencials IMAP existents per a habilitar les notificacions necessàries per correu electrònic, per exemple, per al registre d'usuaris.",
  'SMTP host': 'Amfitrió SMTP',
  'SMTP port': 'Port SMTP',
  'Upload family tree': "Pujar l'arbre genealògic",
  'Optionally, upload existing family tree data.':
    "Opcionalment, carregueu les dades existents de l'arbre genealògic.",
  Submit: 'Enviar',
  'Unsupported format': 'Format no suportat',
  'The Gramps package format (.gpkg) is currently not supported.':
    'El format de paquet Gramps (.gpkg) no està suportat actualment.',
  'If you intend to synchronize an existing Gramps database with Gramps Web, use the Gramps XML (.gramps) format instead.':
    'Si tens intenció de sincronitzar una base de dades Gramps existent amb Gramps Web, utilitza el format Gramps XML (.gramps).',
  ...
  'Manually updating the search index is usually unnecessary, but it may become necessary after an upgrade.':
    "Normalment no és necessari actualitzar manualment l'índex de cerca, però pot ser'ho després d'una actualització.",
  'New account registered successfully.':
    "Nou compte d'usuari registrat amb èxit.",
  'A password reset link has been sent by e-mail.':
    "S'ha enviat un enllaç de restabliment de contrasenya per correu electrònic.",
  ...
  'Generate a ZIP archive with all media files.':
    'Genera un arxiu ZIP amb tots els arxius multimèdia.',
  ...
  'Please confirm your e-mail address by clicking the link in the e-mail you received and then wait for the tree owner to activate your account.':
    "Si us plau, verifica la teva direcció de correu electrònic fent clic a l'enllaç que hauràs rebut i espera que el propietari de l'arbre activi el teu compte.",
  ...
  'This e-mail address is already in use':
    "Aquesta direcció de correu electrònic ja s'està utilitzant",
  'This user name is already in use':
    "Aquest nom d'usuari ja s'està utilitzant",
  'Upload a ZIP archive with files for existing media objects.':
    'Carrega un arxiu ZIP amb els arxius dels objectes multimèdia existents.',
  ...
  'This tool checks the database for integrity problems, fixing the problems it can.':
    "Aquesta eina comprova els problemes d'integritat de la base de dades, i els arregla si pot.",
  ...
  '%s media objects with missing checksum':
    '%s objectes multimèdia sense suma de verificació',
