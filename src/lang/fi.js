export default {
  ...
  'Enter the details for the admin user.':
    'Syötä järjestelmänvalvojan käyttäjän tiedot.',
  ...
  "To start using the blog, add a source with tag 'Blog'.":
    'Jos haluat aloittaa blogin käytön, lisää lähde, jonka tunniste on ”Blogi”.',
  'Search %s': 'Hae %s',
  ...
  'Optionally, enter existing IMAP credentials to enable e-mail notifications required e.g. for user registration.':
    'Valinnaisesti voit syöttää olemassaolevat IMAP-tunnukset ottaaksesi käyttöön esim. rekisteröitymiseen vaadittavat sähköposti-ilmoitukset.',
  'The Gramps package format (.gpkg) is currently not supported.':
    'Gramps-pakettimuotoa (.gpkg) ei tueta tällä hetkellä.',
  ...
  'Optionally, upload existing family tree data.':
    'Valinnaisesti voit tuoda olemassaolevan perhepuun.',
  ...
  'Please upload a file in Gramps XML (.gramps) format without media files.':
    'Tuo tiedosto Gramps XML (.gramps) -muodossa ilman mediatiedostoja.',
  ...
  'If you intend to synchronize an existing Gramps database with Gramps Web, use the Gramps XML (.gramps) format instead.':
    'Jos aiot synkronisoida olemassaolevan Gramps-tietokannan Gramps Webiin, käytä Gramps XML (.gramps) -muotoa tämän sijaan.',
  Owner: 'Omistaja',
  ...
  'Manually updating the search index is usually unnecessary, but it may become necessary after an upgrade.':
    'Hakuindeksin päivittäminen on tarpeellista lähinnä vain joidenkin päivitysten jälkeen, ei muulloin.',
  ...
  'Generate a ZIP archive with all media files.':
    'Luo kaikki mediatiedostot sisältävä ZIP-paketti.',
  ...
  'A password reset link has been sent by e-mail.':
    'Salasanan vaihtolinkki on lähetetty sähköpostilla.',
  ...
  'Please confirm your e-mail address by clicking the link in the e-mail you received and then wait for the tree owner to activate your account.':
    'Vahvista sähköpostiosoitteesi napsauttamalla saamasi sähköpostiviestin linkkiä ja odota, että sukupuun omistaja aktivoi tilisi.',
  'Upload a ZIP archive with files for existing media objects.':
    'Lataa ZIP-arkisto, jossa on olemassa olevien mediaobjektien tiedostoja.',
  ...
  'New account registered successfully.':
    'Uusi tili on rekisteröity onnistuneesti.',
